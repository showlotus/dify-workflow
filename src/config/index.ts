...
export const MARKETPLACE_URL_PREFIX = getStringConfig(
  import.meta.env.VITE_MARKETPLACE_URL_PREFIX,
...
export const SUPPORT_MAIL_LOGIN = !!(
  import.meta.env.VITE_SUPPORT_MAIL_LOGIN
...
const COOKIE_DOMAIN = (import.meta.env.VITE_COOKIE_DOMAIN || '').trim()
...
export const DISABLE_UPLOAD_IMAGE_AS_ICON
  = import.meta.env.VITE_DISABLE_UPLOAD_IMAGE_AS_ICON === 'true'
